  ...
  return (
    <button
      ...
      className={[
        ...
        'right-[max(0.75rem,env(safe-area-inset-right))] bottom-[max(0.75rem,env(safe-area-inset-bottom))] h-11 w-11 p-0 max-[425px]:right-[max(1.3rem,env(safe-area-inset-right))] sm:h-auto sm:w-auto sm:p-2.5',
